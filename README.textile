...
to compile run @sbt update compile@. in order to keep up with the scala-refactoring snapshots, you may need to wipe the Ivy2 cache before updating: @rm -r ~/.ivy2/cache/org.scala-refactoring@
